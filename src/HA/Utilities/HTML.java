...
public class HTML {
	...
	public static void prepmail() throws Exception{
		...
		//strHTMLbody = strHTMLbody+htmlsuitebody();
	...
	public static String htmlheaderbody() throws Exception{
		...
		strHTML = strHTML + "<TR><TD  height=12px> <b>Environment Details</b></TD><TD><b>:</b></TD> <TD  height=12px><u><font color='Blue'>"+_properties.getProperty(HATF_properties.BASEURL)+"</font></u></TD> </TR>  ";
		strHTML = strHTML + "<TR><TD  height=12px> <b>Tenant Details</b></TD> <TD><b>:</b></TD><TD  height=12px>"+ _properties.getProperty(HATF_properties.TENANT)+"</TD> </TR>";
	...
	public static String consolidatedmailheaderbody() throws Exception{
		...
		String strHTML = "";
		strHTML = strHTML + "<h3 ALIGN='Left'><u><h2> Host Analytics Consolidated Test Automation Execution Report</h2></u></h3><BR>";
		strHTML = strHTML + "<TABLE ALIGN='Left'>";
		strHTML = strHTML + "<TR><TD  height=12px> <b>Environment Details</b></TD><TD><b>:</b></TD> <TD  height=12px><u><font color='Blue'>"+_properties.getProperty(HATF_properties.BASEURL)+"</font></u></TD> </TR>  ";
		...
		strHTML = strHTML + "<TR>";
		strHTML = strHTML + "<TD bgcolor='#A0CFEC' width=100px height=50px ALIGN='Center'><font face=Arial size=2><b>Module</b></font></TD>";
		strHTML = strHTML + "<TD bgcolor='#A0CFEC' width=100px height=50px ALIGN='Center'><font face=Arial size=2><b>Tenant</b></font></TD> ";
...
//		strHTML = strHTML + "<TD bgcolor='#A0CFEC' width=100px height=50px ALIGN='Center'><font face=Arial size=2><b>Execution Start Time</b></font></TD> ";
//		strHTML = strHTML + "<TD bgcolor='#A0CFEC' width=100px height=50px ALIGN='Center'><font face=Arial size=2><b>Execution End Time</b></font></TD> ";
